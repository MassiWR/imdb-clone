...
Route::group(['middleware' => ['AuthCheck']], function () {
    ...
    Route::get('/watchlist/add_to_watchlist/{id}', [WatchlistController::class, 'create']);
    Route::get('/watchlist/remove_from_watchlist/{id}', [WatchlistController::class, 'destroy']);
